...
int link_action_id = -1;

void stop(){
    std::cout << "asgard:echo: stop the driver" << std::endl;

    asgard::unregister_action(driver, source_id, link_action_id);
...
int main(){
    ...
    link_action_id = asgard::register_action(driver, source_id, "SIMPLE", "link");
